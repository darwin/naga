...
class CPythonObject {
 public:
  ...
  static v8::Local<v8::ObjectTemplate> CreateJSWrapperTemplate(const v8::IsolatePtr& v8_isolate);
  static v8::Local<v8::ObjectTemplate> GetOrCreateCachedJSWrapperTemplate(const v8::IsolatePtr& v8_isolate);

  static void ThrowJSException(const v8::IsolatePtr& v8_isolate,
