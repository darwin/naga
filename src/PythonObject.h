...
class CPythonObject {
 public:
  ...
  static v8::Local<v8::ObjectTemplate> CreateJSWrapperTemplate(v8::LockedIsolatePtr& v8_isolate);
  static v8::Local<v8::ObjectTemplate> GetOrCreateCachedJSWrapperTemplate(v8::LockedIsolatePtr& v8_isolate);

  static void ThrowJSException(v8::LockedIsolatePtr& v8_isolate, const py::error_already_set& py_ex = py::error_already_set());
};
