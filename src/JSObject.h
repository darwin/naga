...
//  py::object ToPythonStr() const;
  pb::object ToPythonInt2() const;
  pb::object ToPythonFloat2() const;
  pb::object ToPythonBool2() const;
  pb::object ToPythonStr2() const;
...
//  static py::object Wrap(v8::Local<v8::Object> obj, v8::Local<v8::Object> self = v8::Local<v8::Object>());
  ...
  static pb::object Wrap(CJSObjectPtr obj);
