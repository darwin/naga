...
class ObjectTracer2 {
 ...
 public:
  ObjectTracer2(v8::Local<v8::Value> handle, PyObject* object);
  ~ObjectTracer2();

  pb::object Object() const { return pb::reinterpret_borrow<pb::object>(m_object); }

  void Dispose();

  static ObjectTracer2& Trace(v8::Local<v8::Value> handle, PyObject* object);

  static v8::Local<v8::Value> FindCache(PyObject* obj);
};
